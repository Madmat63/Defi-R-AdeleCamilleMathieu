...
```{r Graphique Profil, echo=FALSE, message=FALSE, warning=FALSE,fig.keep='last'}
Graphique(Clust,4)
```
<br><br>
...
```{r Graphique BigOne,fig.keep = 'last'}
BigOne(expData,8,MetDist = "correlation",MetClust = "HCL",MetGraph = "heatmap")
```
